...
?>
        <section class="add-category products-add profile-details">
                 ...
                 <form class="category-form" method="POST" action="{{ url('profile-update') }}"  enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="user_image-block">
                        <div class="file-upload">
                            <div class="image-upload-wrap">
                                ...
                                <div class="drag-text">
                               <img src="{{asset('User/images/'.$data[0]->image)}}"  width="300" height="300">
                                </div>
                            </div>
                            ...
                            <div class="upload-img">
                                ...
                                <img src="{{asset('User/images/OBJECTS.svg')}}">
